                ...
                <div key={q.id} className="review-item">
                  ...
                  <div className="review-answers">
                    {q.options.map((opt, oi) => {
                      ...
                      return (
                        <div key={oi} className={`review-answer ${isCorrect ? 'correct-ans' : 'wrong-ans'}`}>
                          {isCorrect ? <CheckSm /> : <XSm />}
                          {opt}
                        </div>
                      )
                    })}
...
function RetryIcon() { return <svg width="28" height="28" fill="none" stroke="var(--red)" strokeWidth="1.5" viewBox="0 0 24 24"><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 102.13-9.36L1 10" strokeLinecap="round" strokeLinejoin="round"/></svg> }
function CheckSm() { return <svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" style={{flexShrink:0}}><polyline points="20 6 9 17 4 12"/></svg> }
function XSm() { return <svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" style={{flexShrink:0}}><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg> }
